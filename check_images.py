...
# PROGRAMMER: Pranav Menon
# DATE CREATED: 01/02/20                       
# REVISED DATE: 01/05/20
# PURPOSE: dii gineerClassifies pet images using a pretrained CNN model, compares these
...
def main():
    ...
    print("\n\n****** FINAL RESULTS *******\n\n")
    print("{}       {}          {}       {}       {}".format("Architecture", "not Dog C", "Dog C", "Breed C", "Match Labels"))
